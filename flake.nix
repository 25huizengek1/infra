{
  ...
  inputs = {
    ...
    # nixpkgs-continuwuity.follows = "nixos-small"; # .url = "github:bartoostveen/nixpkgs/matrix-continuwuity-26.7.0";
    # TODO: remove
    nixpkgs-continuwuity.url = "github:bartoostveen/nixpkgs/matrix-continuwuity-26.8.1-unstable-2026-08-28";
