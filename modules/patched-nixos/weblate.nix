# Vendored from https://github.com/NixOS/nixpkgs/blob/nixos-25.05/nixos/modules/services/web-apps/weblate.nix
    ...
    ''
      ...
      CACHES = {
        ...
        "avatar": {
          ...
          "LOCATION": f"{DATA_DIR}/avatar-cache",
          "TIMEOUT": 86400,
  ...
  options = {
    services.weblate = {
      ...
      unixSocket = lib.mkOption {
        description = "The path to the socket gunicorn will listen to.";
        example = "/run/gunicorn.socket";
        default = "/run/weblate.socket";
        type = lib.types.str;
      };

      siteTitle = lib.mkOption {
        description = "Title of the Weblate server.";
        example = "My Weblate server";
        default = "Weblate";
        type = lib.types.str;
      };
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.weblate = {
      ...
      serviceConfig = {
        ...
        ExecStart =
          let
            gunicorn = cfg.gunicornPackage.overridePythonAttrs (old: {
